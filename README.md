...
Once you've completed your first portfolio project review, you'll switch to using a [local environment](https://help.learn.co/en/articles/1394611-when-should-i-set-up-a-local-environment). There are a lot of parts to a development environment, and the set up is different for different operating systems - the guide points to the right instructions for each system.
